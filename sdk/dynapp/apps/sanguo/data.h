...
typedef struct {
  ...
  unsigned char startOwner;
  unsigned short startTroops;
  unsigned char farm, market, walls;
} CityDef;
typedef struct {
  const char* name;
  unsigned char war, wit, owner, city;
} GeneralDef;
static const CityDef kCities[SG_CITIES] = {
    {"长安", 1026, kNeutral, 13000, 3, 2, 3}, {"洛阳", 13, 0, 10000, 3, 3, 3},
    {"邺城", 18, 0, 9000, 3, 3, 2},           {"许昌", 562, 0, 11000, 3, 3, 2},
    {"徐州", 44, kNeutral, 15000, 2, 2, 2},   {"寿春", 88, kNeutral, 8000, 2, 2, 2},
    {"建业", 160, 2, 11000, 3, 4, 2},         {"柴桑", 320, 2, 9000, 3, 3, 2},
    {"江陵", 2688, kNeutral, 9000, 3, 2, 2},  {"襄阳", 1288, kNeutral, 10000, 2, 2, 3},
    {"汉中", 2561, 1, 9000, 3, 2, 3},         {"成都", 1280, 1, 11000, 4, 2, 3}};
