...
#include "components/themes/retro/RetroTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  ...
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::INX:
      ...
      break;
    case CrossPointSettings::UI_THEME::RETRO:
      LOG_DBG("UI", "Using Retro theme");
      nextTheme = makeUniqueNoThrow<RetroTheme>();
      nextMetrics = &RetroMetrics::values;
      break;
    default:
