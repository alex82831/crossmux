...
constexpr GeneralDef kGenerals[kGeneralCount] = {
    {"曹操", 72, 91, 0, 1},  {"张辽", 92, 78, 0, 3},  {"夏侯惇", 90, 60, 0, 2}, {"司马懿", 63, 96, 0, 1},
    {"许褚", 94, 36, 0, 3},  {"刘备", 73, 78, 1, 11}, {"关羽", 97, 79, 1, 11},  {"张飞", 96, 45, 1, 10},
    {"赵云", 96, 76, 1, 11}, {"诸葛亮", 55, 100, 1, 10}, {"孙权", 67, 80, 2, 6}, {"周瑜", 71, 96, 2, 6},
    {"太史慈", 93, 66, 2, 7}, {"吕蒙", 81, 89, 2, 7}, {"甘宁", 94, 58, 2, 6},  {"吕布", 100, 26, kNeutral, 4},
    {"马超", 97, 44, kNeutral, 0}, {"黄忠", 93, 60, kNeutral, 9}, {"庞德", 90, 58, kNeutral, 0},
    {"魏延", 89, 69, kNeutral, 8},
};
