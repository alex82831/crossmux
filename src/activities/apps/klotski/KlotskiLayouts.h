...
constexpr Layout kLayouts[] = {
    {"将拥曹营",
     49,
     {{PieceType::Soldier, 0, 0},
      {PieceType::Cao, 1, 0},
      {PieceType::Soldier, 3, 0},
      {PieceType::Soldier, 0, 1},
      {PieceType::Soldier, 3, 1},
      {PieceType::Vert, 0, 2},
      {PieceType::Horz, 1, 2},
      {PieceType::Vert, 3, 2},
      {PieceType::Vert, 1, 3},
    ...
    {"水泄不通",
     ...
     {{PieceType::Horz, 0, 0},
      ...
      {PieceType::Vert, 2, 2},
      {PieceType::Vert, 3, 2},
      {PieceType::Soldier, 0, 3},
      {PieceType::Soldier, 1, 3},
      {PieceType::Soldier, 0, 4},
      {PieceType::Soldier, 1, 4}}},
    {"雨声淅沥",
     78,
     {{PieceType::Cao, 0, 0},
      {PieceType::Vert, 2, 0},
      {PieceType::Vert, 3, 0},
      {PieceType::Soldier, 2, 2},
      {PieceType::Soldier, 3, 2},
      {PieceType::Horz, 0, 2},
      {PieceType::Soldier, 0, 3},
      {PieceType::Soldier, 3, 3},
      {PieceType::Horz, 0, 4},
      {PieceType::Horz, 2, 4}}},
    {"齐头并进",
     85,
